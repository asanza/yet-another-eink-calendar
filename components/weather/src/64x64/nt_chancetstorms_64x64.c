#include "weather.h"
#define NT_CHANCETSTORMS_64X64_WIDTH 64 
#define NT_CHANCETSTORMS_64X64_HEIGHT 64 
const struct icon icon_nt_chancetstorms_64x64 = {
    .w = NT_CHANCETSTORMS_64X64_WIDTH,
    .h = NT_CHANCETSTORMS_64X64_HEIGHT,
    .data = {
