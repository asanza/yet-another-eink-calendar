#include "weather.h"
#define NT_UNKNOWN_128X128_WIDTH 128 
#define NT_UNKNOWN_128X128_HEIGHT 128 
const struct icon icon_nt_unknown_128x128 = {
    .w = NT_UNKNOWN_128X128_WIDTH,
    .h = NT_UNKNOWN_128X128_HEIGHT,
    .data = {
