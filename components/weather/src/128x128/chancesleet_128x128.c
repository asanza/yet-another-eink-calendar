#include "weather.h"
#define CHANCESLEET_128X128_WIDTH 128 
#define CHANCESLEET_128X128_HEIGHT 128 
const struct icon icon_chancesleet_128x128 = {
    .w = CHANCESLEET_128X128_WIDTH,
    .h = CHANCESLEET_128X128_HEIGHT,
    .data = {
