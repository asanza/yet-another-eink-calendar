#include "weather.h"
#define MOSTLYCLOUDY_128X128_WIDTH 128 
#define MOSTLYCLOUDY_128X128_HEIGHT 128 
const struct icon icon_mostlycloudy_128x128 = {
    .w = MOSTLYCLOUDY_128X128_WIDTH,
    .h = MOSTLYCLOUDY_128X128_HEIGHT,
    .data = {
