#include "weather.h"
#define FLURRIES_128X128_WIDTH 128 
#define FLURRIES_128X128_HEIGHT 128 
const struct icon icon_flurries_128x128 = {
    .w = FLURRIES_128X128_WIDTH,
    .h = FLURRIES_128X128_HEIGHT,
    .data = {
