#include "weather.h"
#define CHANCETSTORMS_128X128_WIDTH 128 
#define CHANCETSTORMS_128X128_HEIGHT 128 
const struct icon icon_chancetstorms_128x128 = {
    .w = CHANCETSTORMS_128X128_WIDTH,
    .h = CHANCETSTORMS_128X128_HEIGHT,
    .data = {
