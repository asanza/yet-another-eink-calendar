#include "weather.h"
#define NT_PARTLYSUNNY_32X32_WIDTH 32 
#define NT_PARTLYSUNNY_32X32_HEIGHT 32 
const struct icon icon_nt_partlysunny_32x32 = {
    .w = NT_PARTLYSUNNY_32X32_WIDTH,
    .h = NT_PARTLYSUNNY_32X32_HEIGHT,
    .data = {
