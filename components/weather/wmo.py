...
url = "http://api.open-meteo.com"
url += "/v1/dwd-icon?latitude=48.78"
url += "&longitude=9.18"
url += "&hourly=temperature_2m,precipitation,weathercode,precipitation_probability"
url += "&daily=sunrise,sunset,weathercode,precipitation_probability_mean&timezone=Europe/Berlin"
url += "&current_weather=true"
url += "&timeformat=unixtime"
url += "&start_date=2025-06-01"
url += "&end_date=2025-06-01"
